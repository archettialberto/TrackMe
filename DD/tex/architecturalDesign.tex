...
\label{sec:arcdes}
  ...
  \label{sec:stylesandpatterns}
    ...
    \begin{description}
      ...
      \item[Thin client] Data and logic of the system are handled in the data and business layer respectively. The presentation layer has the only role of showing data to the user and performing requests that will be handled by the other layers. (Figure~\ref{fig:thinclient})
    ...
    \begin{figure}[h!]
      \centering
      \includegraphics[width=.7\linewidth]{\fetchImg{util/ThinClient.jpg}}
