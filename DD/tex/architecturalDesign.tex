...
\label{sec:arcdes}
  ...
  \label{sec:stylesandpatterns}
    ...
    \begin{figure}[h!]
      \centering
      \includegraphics[width=.85\linewidth]{\fetchImg{util/REST_Diagram.jpg}}
      \caption{REST communication structure}
      \label{fig:REST_structure}
    \end{figure}

    \def \restfulwid {.4\linewidth}
    \begin{figure*}
      \centering
      \begin{tabular}{lll}
        & \textbf{Request} & \textbf{Response} \\[4pt]
        \rotatebox{90}{\textbf{\qquad POST}} & \includegraphics[width=\restfulwid]{\fetchImg{util/RESTful_example_post}} & \includegraphics[width=\restfulwid]{\fetchImg{util/RESTful_example_post_r}} \\
        \rotatebox{90}{\textbf{\qquad GET}} & \includegraphics[width=\restfulwid]{\fetchImg{util/RESTful_example_get}} & \includegraphics[width=\restfulwid]{\fetchImg{util/RESTful_example_get_r}} \\
      \end{tabular}
