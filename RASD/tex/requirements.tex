...
\label{sec:specreq}
  ...
  \subsection{Functional requirements}
    ...
    \begin{description}
      ...
      \item[Payment]
      \item[\texttt{R.M1}] The system shall be able to communicate with an external service that is able to process payments between accounts and TrackMe
  ...
  \subsection{Use cases}
    ...
    \usecase % single user request
      ...
      {Third party, User, Payment Service}
      ...
      {\uclist{
        ...
        \item The system receives user's response
        \item The system instanciates the payment process between Payment Service and the Third Party
        \item The system shares requested data to the third party
      }}
      ...
      {\uclist{
        ...
        \item[9.] Payment process didn't end correctly; \texttt{Data4Help} doesn't share the data
      }}
      {}
      {}
   ...
   \usecase % anonymous group request
      ...
      {\uclist{
       ...
       \item[7.] Payment process didn't end correctly; \texttt{Data4Help} doesn't share the data
      }}
      {}
      {}
    ...
    \usecase % graphical filters
      ...
      {}
      {$^*$ Third parties are allowed to filter data they posses through their graphical interface too}
    ...
    \begin{table}[h!]
      ...
      \begin{tabularx}{.8\linewidth}{|X|X|X|X|}
        ...
        \hline
        \texttt{r5} & \texttt{G.T1} & \texttt{R.A3}, \texttt{R.I3}, \texttt{R.R1}, \texttt{R.R2}, \texttt{R.R3}, \texttt{R.M1} & \texttt{UC.5}  \\
        \hline
        \texttt{r6} & \texttt{G.T2} & \texttt{R.A3},  \texttt{R.D2}, \texttt{R.D5}, \texttt{R.D6}, \texttt{R.I3}, \texttt{R.R4}, \texttt{R.R5}, \texttt{R.R6}, \texttt{R.M1} & \texttt{UC.6}   \\
        \hline
