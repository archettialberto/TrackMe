...
The system requires the users(both Data4Help and AutomatedSOS) and third Parties(only in Data4Help), in order to exploit all the functionalities of the app and avoid unauthorized access(both Data4Help and AutomatedSOS), to authenticate through username and password which are stored
