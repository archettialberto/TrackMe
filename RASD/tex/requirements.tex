...
%Paul is studying Telecommunication Engineering at Politecnico di Milano and would like to partecipate at the PolimiRun therefore he is training twice a week since January(the PolimiRun occurs in May). He decides to create a User Account sharing heartbeat and blody ossygen with Data4Help. The system checks that all the required information are properly added then it starts to collect the two user data entries creating a Dataset for the student. At the end of April Paul is worried that despite all the efforts the PoliRun is too harsh for him so decides to  
