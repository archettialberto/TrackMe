...
\begin{figure}[h!]
  ...
  \begin{subfigure}[b]{0.4\linewidth}
    \includegraphics[width=\linewidth]{registration_tp.png}
    \caption{Registration of the Third Party}
  \end{subfigure}
  \begin{subfigure}[b]{0.4\linewidth}
    \includegraphics[width=\linewidth]{registration_user.png}
    \caption{Registration of the User}
  \end{subfigure}
\end{figure}
\begin{figure}
  \begin{subfigure}[b]{0.4\linewidth}
    \includegraphics[width=\linewidth]{user_settings.png}
    \caption{User setting}
  \end{subfigure}
  \begin{subfigure}[b]{0.4\linewidth}
    \includegraphics[width=\linewidth]{user_sidebar.png}
...
%TODO in case there are no data?
...
Data4Help, as \ref{sec:datagathering} says, has to collect data through multiple physical wearables devices therefore 
