...
The system has to gather user's data through multiple devices as \ref{sec:datagathering} says. Therefore this product function, related to Data Gathering, must be implemented in such a way that different physical wearables can send data to the app.
