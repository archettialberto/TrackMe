  ...
  \label{sec:revhistory}
    \begin{table}[!h]
      \begin{tabularx}{\linewidth}{|l|c|X|}
        ...
        2/12/2018 & \texttt{v.2} & Typo correction, requirement numbering correction, added payment requirement, use cases and traceability matrix updated according to the new requirement, enhanced look and feel \\ \hline
      \end{tabularx}
    \end{table}
