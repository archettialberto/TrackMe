...
\label{sec:intro}
  ...
  \subsection{Scope}
      ...
      \subsubsection{Goals}
        ...
        % FABIO ho commentato i goal perché secondo me ci conviene metterli una volta che abbiamo definito anche domain assumptions e requirements, magari martedì?
  ...
  \subsection{Definitions, acronyms, abbreviations}
    ...
    \subsubsection{Definitions}
      ...
      \begin{description}
        \item[]
        %\item [Data Set]
        % FABIO prima di threshold ci conviene definire quali parametri raccogliere e cos'è un "set" di parametri per un utente, tipo vettore
      ...
      % FABIO ho pensato ad un modo per aggirare il problema della scelta dell'utente di poter cambiare i permessi sulle sue condivisioni: domani ti spiego e ridefiniamo Data Set se ti va bene l'idea
  ...
  \subsection{Assumptions, dependencies, constraints}
    ...
    \subsubsection{Domain assumptions}
      ...
      \begin{description}
        ...
        \item[\texttt{D2}] da 2
      \end{description}
      % FABIO stesso dircorso dei goal, ci conviene definirli tutti assieme
